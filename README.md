...
프로젝트를 시작할 때는 제 부족함과 실력에 대한 막연한 두려움이 있었습니다. 하지만 프로젝트를 진행하며 어려움을 겪으면서, 배우려는 자세와 의지만 있다면 결과와 상관없이 저를 더 단단하게 만들어주는 실력과 경험을 얻을 수 있음을 깨달았습니다.

앞으로도 제가 모르는 기술들은 끝없이 쏟아져 나올 것입니다. 그 사실이 두렵기도 하고 때로는 자신감을 잃기도 하겠지만 차근히 공부하다보면 꾸준히 성장하게 될 것입니다. 여정 자체가 저에게 가장 큰 보상이 된다는 것을 깨닫게 되었습니다.
