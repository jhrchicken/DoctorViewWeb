...
### 🔹 프로젝트 구조 만듦 (옆에 위에 설명이랑 주석 적는 건 아직 안함)<br/>
### 🔹 문제 해결 과정에서 '문제가 있었습니다'라고 끝나는게 개수상함 ㅡㅡ
...
도메인 주도 개발, ORM, 객체지향 프로그래밍 등에서 도메인형 구조가 더 적합하다고 생각한다. 도메인 주도 개발에서 Root Aggregate 같은 표현은 계층형보다 도메인형으로 표현했을 경우 훨씬 더 직관적이며 해당 도메인을 이해하는 것에도 효율적이다. 어쩌구 ~~
