...
🔵 표지 추가했습니다 (사진은 바꿀 예정)
🔵 목차 만들었습니다 (중요하진 않은데 세부적인 타이틀은 나중에 더 적합하게 바꿀 예정)
🔵 주요기능에서 로그인이랑 예약 설명 추가했습니다 (내 기준 완성)
🔵 프로젝트 구조 만들었습니다 (주석 있/없/간단히있 적어뒀는데 셋 중에 마음에 드는거 하나 남기고 지워주세요 수정도 당연히 가능)
🔵 프로젝트 구조에 설명 적어뒀는데 몇 가지 고민이 있음 ..
1. 겨우 프로젝트 구조 따위에 너무 친절한 설명을 적어주나? 없는건 좋지 않을거같고 간단하게 한다고 한건데 마음에 안듦
2. 프로젝트 설명에 도메인형 구조 채택했다는 사실 + 그 이유를 중점으로 적고 싶었는데 그게 잘 안 드러나는거 같음 뭔가 성과 중심
